...
const LoadedVehicleReducer = (state = initialState, action) => {
    const newState = { ...state };

    switch (action.type) {
        case Types.GET_LOADED_VEHICLE:
            return {
                ...state,
                loadedVehicleList: action.payload.data,
...
export default LoadedVehicleReducer;
