...
const UnloadVehicleReducer = (state = initialState, action) => {
    const newState = { ...state };

    switch (action.type) {
        case Types.GET_UNLOAD_VEHICLE:
            return {
                ...state,
                unloadVehicleList: action.payload.data,
...
export default UnloadVehicleReducer;
