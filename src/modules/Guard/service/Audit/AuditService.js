...
export async function getIncidentPendingList() {
  let data = [];
  ...
  try {
    ...
    let url = `http://api2.akij.net:8068/api/GurdAppReports/GetDataForIncidentApprovePending?intPart=${partId}&intUnit=${unitId}&intJobstation=${jobStationID}&intinsertby=${employeeID}`;

    if (api_get_incident_Pending_list.length !== 0) {
