...
import { getIncidentPendingList } from "../service/Audit/AuditService";
...
export default class AuditScreen extends Component {
  ...
  initializeData = async () => {
    let getIncidentData = await getIncidentPendingList();
    this.setState({
      incidentPendingList: getIncidentData,
    });
  };
      ...
      <ScrollView>
        <SafeAreaView style={[styles.container]}>
          ...
          <View style={[styles.wrapperView]}>
            ...
            {this.state.incidentPendingList.map((item, index) => (
              <View style={{ flex: 1, flexDirection: "row" }}>
                <View
