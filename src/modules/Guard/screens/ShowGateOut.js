...
export default class ShowGateOut extends Component {
  state = {
    refreshing: false,
        ...
        <SafeAreaView style={[styles.container]}>
          <Modal isVisible={this.state.isModalVisible}>
            <View style={[styles.SuccessfulBox]}>
              <Text style={[styles.secSubTitle]}> Are you sure </Text>
              <Text> want to get out? </Text>
              <View
          ...
          <View style={[styles.selectBox]}>
            <View style={{ flex: 1, flexDirection: "row" }}>
              <View style={{ flexBasis: "70%" }}>
                <Text style={[styles.headTitle]}>Show Gate Out</Text>
              </View>
            </View>
          </View>
          ...
          <View style={[styles.selectBox]}>
            ...
            >
              <View style={{ flexBasis: "75%" }}>
                <Text style={[styles.shipDate]}> Entry Time </Text>
              </View>
              <View style={{ flexBasis: "22%" }}>
                <Text style={[styles.shipDate]}> Entry Date </Text>
              </View>
            </View>
            ...
            >
              <View style={{ flexBasis: "75%" }}>
                <Text style={[styles.shipDate]}> Vehicle Type </Text>
              </View>
            </View>
            ...
            >
              <View style={{ flexBasis: "75%" }}>
                <Text style={[styles.shipDate]}> To Whom To Visited </Text>
              </View>
              <View style={{ flexBasis: "22%" }}>
                <Text style={[styles.shipDate]}> From Where </Text>
              </View>
            </View>
          ...
          {/* <View style={{ marginTop: 10 }}>
            <TouchableOpacity onPress={() => this.toggleModal()}>
              <Text style={styles.buttonStyle}>GET OUT</Text>
            </TouchableOpacity>
          </View> */}
        </SafeAreaView>
      </ScrollView>
