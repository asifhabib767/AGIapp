...
import { getCheckpointSummary } from "../service/checkpoint/CheckpointService";
...
export default class CheckpointList extends Component {
  ...
  initializeData = async () => {
    ...
    let checkpointSummaryData = await getCheckpointSummary();
    this.setState({
      checkpointSummaryList: checkpointSummaryData,
    });
    this.setState({
        ...
        <Animatable.View animation="slideInUp">
          <SafeAreaView style={styles.container}>
            <View style={[styles.areaBox]}>
              <View style={{ flex: 1, flexDirection: "row" }}>
                <View style={{ flexBasis: "70%" }}>
                  <Text style={[styles.headerLabel]}>
                    {translate("checkpoints", this.state.system_lang)}
                  </Text>
                </View>
              ...
              {this.state.checkpointSummaryList.map((item, index) => (
                <View>
                  <View
                  ...
                  >
                    ...
                    <View style={{ flexBasis: 60, paddingTop: 1 }}>
                      <Text>
                        {item.dteInsertTime != null
                          ? item.dteInsertTime.substring(11, 19)
                          : "00:00:00"}
                      </Text>
                    </View>
                  </View>
                  ...
                  <View style={[styles.floorDetails]}>
                    <View style={{ flexBasis: "80%" }}>
                      <Text style={[styles.floorName]}>
                        Floor: {item.intFloorID}, {item.strJobStationName}
                      </Text>
                    </View>

                    <View style={{ flexBasis: 60, paddingTop: 1 }}>
                      <Text style={{ color: "#44588A" }}>200m</Text>
                    </View>
                  </View>
                </View>
              ))}
