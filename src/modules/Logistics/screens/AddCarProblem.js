...
export default class AddCarProblem extends Component {
  state = {
    providerType: '',
    VehicleCapacity: '',
    SelectVehicle: '',
    ...
    return (
      <ScrollView style={[styles.fullbg]}>
        <SafeAreaView style={styles.container}>
          <Text style={[styles.headingOne]}> সমস্যা অ্যাড করুন </Text>
          ...
          <View style={[styles.selectBox]}>
            <View style={{flex: 1, flexDirection: 'row'}}>
              ...
              <View style={[styles.selectBoxStyle]}>
                <TouchableOpacity onPress={this.showDateTimePicker}>
                  <Text style={[styles.inputLebel]}> সময় </Text>
                  <Text
                    title="Show DatePicker"
                    onPress={this.showDateTimePicker}
                  />
            ...
            <View>
              <Text style={[styles.inputLabel]}>
                {' '}
                সারসংক্ষেপ <Text style={{color: '#D71920'}}>*</Text>{' '}
              </Text>
              <TextInput
          ...
          <View style={[styles.selectBox]}>
            <Text style={[styles.headingOne]}> ডকুমেন্ট যুক্ত করুন </Text>
          ...
          <View style={[styles.selectBox]}>
            <Text style={[styles.headingOne]}> মন্তব্য </Text>
            <View style={{flex: 1, flexDirection: 'row', paddingVertical: 10}}>
          ...
          <View
            ...
            <LinearGradient
              ...
              style={styles.linearGradient}>
              <TouchableOpacity>
                <Text style={styles.buttonText}>সমস্যা সংরক্ষণ করুন</Text>
              </TouchableOpacity>
            </LinearGradient>
          </View>
          <View>
