import { api_post_requisition, api_get_requisitions, api_get_requisition_items } from '../../../config.json';
...
export async function postRequisition(strRequisitionType, strItem, numQuantity, strPromotionItemImagePath, strComments, outlet, itemData) {
