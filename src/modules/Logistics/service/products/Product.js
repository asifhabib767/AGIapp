import { api_products, api_get_product_price, api_get_product_coa   } from '../../../config.json';
 ...
 */
export async function getProductPrice(ProductId, CustomerId, UomId, SalesTypeId, PriceId) {
    let data = {};
