...
import {
  getDeliveryRequstDo,
  getCompleteReqList,
  getRequisitionSummery,
} from '../service/sales/DeliveryRequisitionService';

export default class RequisitionSummery extends Component {
  state = {
    salesPlan: [],
    DoList: [],
  ...
  async componentDidMount() {
    ...
    // let DoList = await getRequisitionSummery(fromDate, endDate);
  ...
  previousMonth = async () => {
    ...
    let DoList = await getRequisitionSummery(myDateString, fromDate);
    this.setState({DoList});
  };
          ...
          <SafeAreaView style={[styles.container]}>
            <View style={[styles.bgbox]}>
              <View
                ...
                <View>
                  <Text style={[styles.headingOne]}>Requisition Summery</Text>
                </View>
              </View>
