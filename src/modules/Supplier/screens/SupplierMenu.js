...
const SupplierMenu = (props) => {
    ...
    return (
        <KeyboardAvoidingView style={[GlobalStyles.backgroundColor]}>
            <ScrollView>
                <View>
                    <Header title="Transport Provider" />
                    <View style={[styles.container]}>
                        <View style={styles.menuContainer}>
                            <CardMenu
                                image={gateIN}
                                cardText="শিপমেন্ট রিকোয়েস্ট"
                                url={() => props.navigation.navigate('shipmentRequest')}
                                customStyle={styles.cardStyle}
                            />
                            <CardMenu
                                image={gateOUT}
                                cardText="বিলিং রিপোর্ট"
                                url={() => props.navigation.navigate('billingReport')}
                                customStyle={styles.cardStyle}
                            />
                            ...
                            <CardMenu
                                image={gateOUT}
                                cardText="বিল সাবমিট"
                                url={() => props.navigation.navigate('submitBill')}
                                customStyle={styles.cardStyle}
                            />
                            ...
                            <CardMenu
                                image={gateIN}
                                cardText="গাড়ি"
                                url={() => props.navigation.navigate('vehicleList')}
                                customStyle={styles.cardStyle}
                            />
                            ...
                            <CardMenu
                                image={m5}
                                cardText="চালক"
                                url={() => props.navigation.navigate('driverList')}
                                customStyle={styles.cardStyle}
                            />
                        </View>
                    </View>
