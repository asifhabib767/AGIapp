...
export default class PrinterScreen extends Component {
  ...
  componentDidMount() {
    ...
    console.log('props printer value', this.props);
  }
            ...
            onPress={() => {
              ...
              BluetoothManager.connect(row.address).then(
                ...
                (e) => {
                  ...
                  console.log('connected device error', e);
                  alert(e);
                },
              );
            }}>
      ...
      <ScrollView style={styles.container}>
        ...
        <View
          ...
          <Button
            ...
            title="Print"
            onPress={() => {
              this.props.navigation.navigate('escpost', {
                passProps: {
                  scanValue: this.props.route.params.ScanValue,
