...
export default class EscPosMain extends Component {
  _listeners = [];
  ...
  constructor(props) {
    ...
    // };
    this.state = {
      boundAddress: props.route.params.passProps.boundAddress,
      boundName: props.route.params.passProps.name,
      loading: false,
    };
  }
          ...
          <Button
            ...
            onPress={async () => {
              try {
                ...
                await BluetoothEscposPrinter.printText(
                  '日期：' + (new Date(), 'yyyy-mm-dd h:MM:ss') + '\r\n',
                  {},
                );
                await BluetoothEscposPrinter.printText(
                  '销售员：18664896621\r\n',
