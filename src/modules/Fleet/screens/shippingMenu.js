          ...
          <View style={[styles.container]}>
            <View style={styles.menuContainer}>
              <CardMenu
                image={tripOut}
                cardText="My Trip"
                url={() => props.navigation.navigate('tripDashboard')}
              ...
              <CardMenu
                image={tripOut}
                cardText="Ship Statement"
                url={() => props.navigation.navigate('ShipStatement')}
                customStyle={styles.cardStyle}
              />
              <CardMenu
                image={tripOut}
                cardText="Top shit"
                url={() => props.navigation.navigate('TopSheet')}
                customStyle={styles.cardStyle}
              />
              <CardMenu
                image={tripOut}
                cardText="Fuel Log Entry"
                url={() => props.navigation.navigate('fuelLogEntry')}
                customStyle={styles.cardStyle}
              />
              <CardMenu
                image={tripOut}
                cardText="Fuel Log Day Report"
                url={() => props.navigation.navigate('FuelLogDaybaseReport')}
                customStyle={styles.cardStyle}
              />
              <CardMenu
                image={tripOut}
                cardText="Fuel Log Vehicle Report"
                url={() =>
                  props.navigation.navigate('FuelLogVehiclebaseReport')
                }
                customStyle={styles.cardStyle}
              />
            </View>
