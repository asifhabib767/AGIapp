      ...
      <ScrollView>
        <SafeAreaView>
          <View style={[styles.bgbox]}>
            <View>
              <Text style={[styles.headerTitle]}>Internal Safety Audit</Text>
            </View>
            <View>
              <View style={[styles.inputBoxStyle]}>
                <Picker
                  ...
                  <Picker.Item label="Area to be audited" value="" />
              ...
              <View style={[styles.inputBoxStyle]}>
                <Picker
                  ...
                  style={[styles.selectBoxStyle]}
                  onValueChange={(item, itemIndex) => changeUser(item)}>
                  <Picker.Item label="Audit Frequency in months" value="" />
                  <Picker.Item label={'Officer'} value={1} key={1} />
                  <Picker.Item label={'Engineer'} value={2} key={2} />
                </Picker>
              </View>
