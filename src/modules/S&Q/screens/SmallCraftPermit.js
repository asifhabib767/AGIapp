      ...
      <ScrollView>
        <SafeAreaView>
          <View style={[styles.bgbox]}>
            <View>
              <Text style={[styles.headerTitle]}>Allow Small Craft Permit</Text>
            </View>
            <View>
              <View>
                <TextInput
              ...
              <View style={[styles.multilinestyle]}>
                <View>
                  <Text style={[styles.labelstyle]}> Name of small craft</Text>
                </View>
                ...
                <View>
                  <Text style={[styles.labelstyle]}>
                    We, the undersigned, are satisfied that the checklist-41
                    have been completed correctly and that it is safe for the
                    work to commence.
                  </Text>
                </View>
                ...
                <View style={[styles.inputBoxStyle]}>
                  <Picker
                    ...
                    onValueChange={(item, itemIndex) => changeUser(item)}>
                    <Picker.Item label="Chief Officer" value="" />
                    <Picker.Item label={'Officer'} value={1} key={1} />
                    <Picker.Item label={'Engineer'} value={2} key={2} />
                  </Picker>
                </View>
...
export default SmallCraftPermit;
