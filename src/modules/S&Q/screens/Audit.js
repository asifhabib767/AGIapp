        ...
        <View>
          ...
          <View style={[styles.containerone]}>
            <View style={styles.menuContainer}>
              <CardMenu
                image={reports}
                cardText="Internal Safety"
                url={() => props.navigation.navigate('internalSafety')}
                customStyle={styles.cardStyle}
              />
              <CardMenu
                image={equipment}
                cardText="Company Internal"
                url={() => props.navigation.navigate('companyInternal')}
                customStyle={styles.cardStyle}
              />
              <CardMenu
                image={accident}
                cardText="Shipboard Internal"
                url={() => props.navigation.navigate('shipboardInternal')}
                customStyle={styles.cardStyle}
              />
            </View>
          </View>
