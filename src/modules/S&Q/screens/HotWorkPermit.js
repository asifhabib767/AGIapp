      ...
      <ScrollView>
        <SafeAreaView>
          <View style={[styles.bgbox]}>
            <View>
              <Text style={[styles.headerTitle]}>Hot Work Permit</Text>
            </View>
            <View>
              <View>
                <TextInput
              ...
              <View>
                <TextInput
                  style={[styles.InputField]}
                  placeholder="Personal Assigned to Work"
                  placeholderTextColor={'#000000'}
                />
              </View>
              <View>
                <TextInput
                  style={[styles.InputField]}
                  placeholder="Officer Responsible for Supervision of Work"
                  placeholderTextColor={'#000000'}
                />
              </View>
              <View>
                <TextInput
                  style={[styles.InputField]}
                  placeholder="Officer Responsible for Safety"
                  placeholderTextColor={'#000000'}
                />
              </View>
              ...
              <View>
                <Text style={[styles.Conductstyletwo]}>
                  I) Has the procedure-4.7 in Fleet Instruction manual been
                  followed?
                </Text>
              ...
              <View style={[styles.abilitystyle]}>
                <Text style={[styles.Conductstyletwo]}>
                  I) Has items from 1-20 in the Hot Work checklist no. 21 been
                  completed?
                </Text>
                ...
                <View style={{flexBasis: '100%'}}>
                  <View style={[styles.inputBoxStyle]}>
                    <Picker
                      ...
                      <Picker.Item label="Reading" value="" />
              ...
              <View>
                <TextInput
                  style={[styles.InputField]}
                  placeholder="Special condition/precautions"
                  placeholderTextColor={'#000000'}
                  fontWeight={'bold'}
                  marginBottom={10}
                />
              ...
              <View style={[styles.abilitystyle]}>
                <Text style={[styles.Conductstyletwo]}>
                  I) Has the equipment or pipeline been gas freed?
                </Text>
              ...
              <View style={[styles.abilitystyle]}>
                <Text style={[styles.Conductstyletwo]}>
                  I) Has the equipment or pipeline been blanked?
                </Text>
              ...
              <View style={[styles.abilitystyle]}>
                <Text style={[styles.Conductstyletwo]}>
                  I) Is the equipment or pipeline free of liquid?
                </Text>
                ...
                <Text style={[styles.Conductstyletwo]}>
                  I) Is the equipment isolated electrically?
                </Text>
                ...
                <Text style={[styles.Conductstyletwo]}>
                  I) Is additional fire protection available?
                </Text>
                  ...
                  <View style={{flexBasis: '49%', marginLeft: 10}}>
                    <View style={[styles.inputBoxStyle]}>
                      <Picker
                        ...
                        onValueChange={(item, itemIndex) => changeUser(item)}>
                        <Picker.Item label="Person carrying" value="" />
                        <Picker.Item label={'Officer'} value={1} key={1} />
                        <Picker.Item label={'Engineer'} value={2} key={2} />
                      </Picker>
                    </View>
                ...
                <View>
                  <Text style={[styles.Conductstylethree]}>General</Text>
                  <Text style={[styles.Conductstyleone]}>
